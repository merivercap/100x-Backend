...
const RDS_HOSTNAME = process.env.RDS_HOSTNAME || 'hundredx-dev3.ccufiluhcjan.us-west-1.rds.amazonaws.com';
...
const RDS_DB_NAME = process.env.RDS_DB_NAME || 'hundredx_dev3';
